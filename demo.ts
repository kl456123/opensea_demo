...
async function englishAuctionTest(buyer: string, seller: string, asset: OpenSeaAsset) {
    ...
    console.log(englishAuctionSellOrder.saleKind)
    ...
    const isMatch = await seaport._validateMatch({ buy: buyOrder, sell: sellOrder, accountAddress: alice })
    console.log('ismatch: ', isMatch)
    if (false) {
        await submitOrders({ buy: buyOrder, sell: sellOrder, accountAddress: alice })
    } else {
